...
const DoctorDBSEmail = () => {
  ...
  const [savedRecord, setSavedReocrd] = useState('')
  const [failedRecord, setFailedRecord] = useState('')
      ...
      <CCard className="mb-4" style={{ width: '60%', margin: '0 auto' }}>
        ...
        <CForm>
          <div className="m-3">
            ...
            <p>Total Record Saved: {savedRecord} </p>
            <p>Total Record Failed: {failedRecord} </p>
